...
const (
	...
	// See SubmitOptions.IncludeCounts and IncludeExperienceDetail.
...
type SubmitOptions struct {
	...
	// IncludeCounts and IncludeExperienceDetail are the optional sections of
	...
	// required on that operation: with neither set it is OpProfilesEnrich,
	// which returns the same record for less.
	//
